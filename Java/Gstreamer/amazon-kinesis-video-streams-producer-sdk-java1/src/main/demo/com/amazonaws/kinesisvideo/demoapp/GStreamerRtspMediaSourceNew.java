...
import com.amazonaws.kinesisvideo.java.mediasource.*;
...
@NotThreadSafe
public class GStreamerRtspMediaSourceNew implements MediaSource {
    ...
    public GStreamerRtspMediaSourceNew(final URI rtspUri, final Duration retentionPeriod, final Tag[] tags) {
    ...
    private class Runner {
        ...
        private Pipeline initPipeline() {
            ...
            filter.set("caps", Caps.fromString("video/x-h264,width=470,height=470,stream-format=avc,alignment=au"));
...
//                    //System.out.println(Element.linkPads(source, pad.getName(), depay, "sink"));
