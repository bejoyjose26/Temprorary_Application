...
async function startViewer(localView, remoteView, formValues, onStatsReport, onRemoteDataMessage) {
    ...
    // console.log('[VIEWER] Endpoints: ', kinesisVideoClient);
    // console.log('[VIEWER] Endpoints: ', describeSignalingChannelResponse);
    // console.log('[VIEWER] Endpoints: ', channelARN);
    // console.log('[VIEWER] Endpoints: ', getSignalingChannelEndpointResponse);
    ...
    console.log('[VIEWER] ICE servers: ', viewer.signalingClient);
    alert("HI")
    ...
    // console.log('[VIEWER] Connected to signaling service',resolution);
    // console.log('[VIEWER] Connected to signaling service',constraints);
    // console.log('[VIEWER] Connected to signaling service',configuration);
    // console.log('[VIEWER] Connected to signaling service',viewer.peerConnection);
 
    
    // Poll for connection stats
    viewer.peerConnectionStatsInterval = setInterval(() => viewer.peerConnection.getStats().then(onStatsReport), 1000);
    console.log('[VIEWER] ICE servers: ',  viewer.peerConnectionStatsInterval);
    alert("HI")
