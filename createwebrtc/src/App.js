...
function App() {
  ...
  async function startViewer() {
    ...
    // console.log('[VIEWER] ICE servers1: ', resolution);      
    // console.log('[VIEWER] ICE servers1: ', constraints);
    // console.log('[VIEWER] ICE servers1: ', configuration);
    // console.log('[VIEWER] ICE servers1: ', viewer.peerConnection);
    //console.log('[VIEWER] ICE servers1: ', clientId);
