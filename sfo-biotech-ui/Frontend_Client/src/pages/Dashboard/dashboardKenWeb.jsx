...
export default function Dashboard() {
  ...
  function onStatsReport(report) {
    ...
    async function startMaster() {
      ...
      const remoteListView = document.getElementsByClassName(' remote-list-view')[0];
    ...
    // Get ICE server configuration
      ...
      master.signalingClient.on('sdpOffer', async (offer, remoteClientId) => {
        ...
        peerConnection.addEventListener('track', event => {
          ...
          remoteListView.srcObject = viewer.remoteStream;
          // remoteListView.forEach(element => {
          //   element.srcObject = viewer.remoteStream;
          // });(int i=0;i< remoteListView.length;i++){
          //   remoteListView[i].srcObject = viewer.remoteStream;
          // }
    ...
    <div className="desktop-Grid">
      ...
      <div className="fuction-Grid">
        <div className="list-video-container"> 
            <div className="video-container"><video className="remote-list-view" autoPlay playsInline controls /></div>
        </div>
        <div className="list-video-container"> 
            <div className="video-container"><video className="remote-list-view" autoPlay playsInline controls /></div>
        </div>
      ...
      <div className="video-scroll-Grid-List">
        ...
        <div>
            <button id="master-button" type="button" className="btn btn-primary" 
                ...
                <button id="master-button" type="button" className="btn btn-primary" 
                onClick={startViewer}> Start Client</button>
        </div>
